package com.example.user.accessaryshopping.liveStreaming.kurentoandroid.one2one;
...
import com.example.user.accessaryshopping.liveStreaming.kurentoandroid.rtc_peer.kurento.KurentoOne2OneRTCClient;
...
public class One2OnePresenter extends MvpBasePresenter<One2OneView>
    ...
    public static final String STREAM_HOST = "wss://54.180.186.195:8443/one2one";
