...
import com.example.user.accessaryshopping.liveStreaming.kurentoandroid.rtc_peer.kurento.KurentoViewerRTCClient;
...
public class ViewerPresenter extends MvpBasePresenter<ViewerView>
    ...
    //이클래스에서 방의 전역변수 설정
    String currentroom;
    //301줄 값을 넘길때 메서드가 거의 동시에 실행된다. 그래서 시간차를 주어 값이 제대로 전달되기 위해서 쓴다.
